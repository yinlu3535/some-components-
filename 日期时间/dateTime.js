...
this.each(function() {
    var $this = $(this);
            ...
            $this.click(function(){
                ...
                if(opt.type=="date"){
                    if(this.value){
                        var curTime = new Date(this.value);
